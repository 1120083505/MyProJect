...
_151.removeClass("tree-file").addClass("icon iconfont");
...
node.find(".tree-icon").removeClass("tree-folder").addClass("icon iconfont");
...
cc.push("<span class=\"tree-icon icon iconfont " + (item.iconCls ? item.iconCls : "") + "\"></span>");
}else{
...
if(_866.hasClass("tree-file")){
    _866.removeClass("tree-file").addClass("icon iconfont ");
...
if(row.state=="closed"){
cc.push("<span class=\"tree-hit tree-collapsed\"></span>");
cc.push("<span class=\"tree-icon icon iconfont  " + (row.iconCls ? row.iconCls : "") + "\"></span>");
}else{
if(row.children&&row.children.length){
cc.push("<span class=\"tree-hit tree-expanded\"></span>");
cc.push("<span class=\"tree-icon icon iconfont " + (row.iconCls ? row.iconCls : "") + "\"></span>");
...
tr.next("tr.treegrid-tr-tree").remove();
var cell=tr.children("td[field=\""+opts.treeField+"\"]").children("div.datagrid-cell");
cell.find(".tree-icon").removeClass("tree-folder").addClass("icon iconfont");
