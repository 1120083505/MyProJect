...
{
    [Serializable]
    public partial class VWeChat_TwoLearnTodoCollection : ReadOnlyList<VWeChat_TwoLearnTodo, VWeChat_TwoLearnTodoCollection>
    {
        public VWeChat_TwoLearnTodoCollection() { }
    }
    [Serializable]
    public partial class VWeChat_TwoLearnTodo : ReadOnlyRecord<VWeChat_TwoLearnTodo>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VWeChat_TwoLearnTodo", TableType.View, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("VWeChat_TwoLearnTodo", schema);
            }
        }
        #endregion
        ...
        #endregion
        #region .ctors 
        public VWeChat_TwoLearnTodo()
        {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VWeChat_TwoLearnTodo(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public VWeChat_TwoLearnTodo(object keyID)
        {
            SetSQLProps();
            LoadByKey(keyID);
        }

        public VWeChat_TwoLearnTodo(string columnName, object columnValue)
        {
            SetSQLProps();
