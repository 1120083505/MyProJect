...
{
    [Serializable]
    public partial class WeChat_HighwayRoadCollection : ActiveList<WeChat_HighwayRoad, WeChat_HighwayRoadCollection>
    {
        public WeChat_HighwayRoadCollection() { }
        public WeChat_HighwayRoadCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WeChat_HighwayRoad o = this[i];
    ...
    [Serializable]
    public partial class WeChat_HighwayRoad : ActiveRecord<WeChat_HighwayRoad>, IActiveRecord
    {
        #region .ctors and Default Settings
        public WeChat_HighwayRoad()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public WeChat_HighwayRoad(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WeChat_HighwayRoad(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WeChat_HighwayRoad(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration 
                TableSchema.Table schema = new TableSchema.Table("WeChat_HighwayRoad", TableType.Table, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("WeChat_HighwayRoad", schema);
            }
        }
        #endregion
        #region Props
        ...
        public static void Insert(string varId, string varTitle, string varAddress, string varAdminId, string varConetent, string varType, DateTime? varPubDate, string varEditAdminId, DateTime? varEditPubDate, string varMemo, string varExt1, string varExt2, string varExt3)
        {
            WeChat_HighwayRoad item = new WeChat_HighwayRoad();
            item.Id = varId;
            item.Title = varTitle;
        ...
        public static void Update(string varId, string varTitle, string varAddress, string varAdminId, string varConetent, string varType, DateTime? varPubDate, string varEditAdminId, DateTime? varEditPubDate, string varMemo, string varExt1, string varExt2, string varExt3)
        {
            WeChat_HighwayRoad item = new WeChat_HighwayRoad();
            item.Id = varId;
            item.Title = varTitle;
