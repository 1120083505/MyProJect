...
{
    [Serializable]
    public partial class WeChat_RoadInformationCollection : ActiveList<WeChat_RoadInformation, WeChat_RoadInformationCollection>
    {
        public WeChat_RoadInformationCollection() { }
        public WeChat_RoadInformationCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WeChat_RoadInformation o = this[i];
    ...
    [Serializable]
    public partial class WeChat_RoadInformation : ActiveRecord<WeChat_RoadInformation>, IActiveRecord
    {
        #region .ctors and Default Settings 
        public WeChat_RoadInformation()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public WeChat_RoadInformation(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WeChat_RoadInformation(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WeChat_RoadInformation(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration 
                TableSchema.Table schema = new TableSchema.Table("WeChat_RoadInformation", TableType.Table, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("WeChat_RoadInformation", schema);
            }
        }
        #endregion
        #region Props 
        ...
        {
            WeChat_RoadInformation item = new WeChat_RoadInformation();
            item.Id = varId;
            item.Title = varTitle;
