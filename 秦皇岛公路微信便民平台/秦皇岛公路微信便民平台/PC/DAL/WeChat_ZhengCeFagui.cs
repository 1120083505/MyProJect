...
{
    [Serializable]
    public partial class WeChat_ZhengCeFaguiCollection : ActiveList<WeChat_ZhengCeFagui, WeChat_ZhengCeFaguiCollection>
    {
        public WeChat_ZhengCeFaguiCollection() { }
        public WeChat_ZhengCeFaguiCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WeChat_ZhengCeFagui o = this[i];
    ...
    [Serializable]
    public partial class WeChat_ZhengCeFagui : ActiveRecord<WeChat_ZhengCeFagui>, IActiveRecord
    {
        #region .ctors and Default Settings 
        public WeChat_ZhengCeFagui()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public WeChat_ZhengCeFagui(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WeChat_ZhengCeFagui(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WeChat_ZhengCeFagui(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration 
                TableSchema.Table schema = new TableSchema.Table("WeChat_ZhengCeFagui", TableType.Table, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("WeChat_ZhengCeFagui", schema);
            }
        }
        #endregion
        #region Props 
        ...
        {
            WeChat_ZhengCeFagui item = new WeChat_ZhengCeFagui();
            item.Id = varId;
            item.Title = varTitle;
