...
{
    [Serializable]
    public partial class VWeChat_RoadInformationCollection : ReadOnlyList<VWeChat_RoadInformation, VWeChat_RoadInformationCollection>
    {
        public VWeChat_RoadInformationCollection() { }
    }
    [Serializable]
    public partial class VWeChat_RoadInformation : ReadOnlyRecord<VWeChat_RoadInformation>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VWeChat_RoadInformation", TableType.View, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("VWeChat_RoadInformation", schema);
            }
        }
        #endregion
        ...
        #endregion
        #region .ctors 
        public VWeChat_RoadInformation()
        {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VWeChat_RoadInformation(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public VWeChat_RoadInformation(object keyID)
        {
            SetSQLProps();
            LoadByKey(keyID);
        }

        public VWeChat_RoadInformation(string columnName, object columnValue)
        {
            SetSQLProps();
