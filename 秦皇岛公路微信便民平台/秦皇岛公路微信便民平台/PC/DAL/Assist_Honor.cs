...
{
    [Serializable]
    public partial class Assist_HonorCollection : ActiveList<Assist_Honor, Assist_HonorCollection>
    {
        public Assist_HonorCollection() { }
        public Assist_HonorCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                Assist_Honor o = this[i];
    ...
    [Serializable]
    public partial class Assist_Honor : ActiveRecord<Assist_Honor>, IActiveRecord
    {
        ...
        public Assist_Honor(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public Assist_Honor(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public Assist_Honor(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration 
                TableSchema.Table schema = new TableSchema.Table("Assist_Honor", TableType.Table, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("Assist_Honor", schema);
            }
        }
        #endregion
        #region Props
        ...
        public static void Insert(string varId, string varCustodyId, string varMemo, string varAdminId, DateTime varPubDate, DateTime? varEditPubDate, string varEditAdminId)
        {
            Assist_Honor item = new Assist_Honor();
            item.Id = varId;
        ...
        public static void Update(string varId, string varCustodyId, string varMemo, string varAdminId, DateTime varPubDate, DateTime? varEditPubDate, string varEditAdminId)
        {
            Assist_Honor item = new Assist_Honor();
            item.Id = varId;
            item.CustodyId = varCustodyId;
