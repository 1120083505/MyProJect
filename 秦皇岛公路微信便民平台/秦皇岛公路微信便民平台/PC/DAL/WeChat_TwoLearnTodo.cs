...
{
    [Serializable]
    public partial class WeChat_TwoLearnTodoCollection : ActiveList<WeChat_TwoLearnTodo, WeChat_TwoLearnTodoCollection>
    {
        public WeChat_TwoLearnTodoCollection() { }
        public WeChat_TwoLearnTodoCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WeChat_TwoLearnTodo o = this[i];
    ...
    [Serializable]
    public partial class WeChat_TwoLearnTodo : ActiveRecord<WeChat_TwoLearnTodo>, IActiveRecord
    {
        #region .ctors and Default Settings 
        public WeChat_TwoLearnTodo()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public WeChat_TwoLearnTodo(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WeChat_TwoLearnTodo(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WeChat_TwoLearnTodo(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration 
                TableSchema.Table schema = new TableSchema.Table("WeChat_TwoLearnTodo", TableType.Table, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("WeChat_TwoLearnTodo", schema);
            }
        }
        #endregion
        #region Props 
        ...
        public static void Insert(string varId, string varTitle, string varConetent, string varAdminId, DateTime? varPubDate, string varEditAdminId, DateTime? varEditPubDate, string varMemo, string varExt1, string varExt2, string varExt3)
        {
            WeChat_TwoLearnTodo item = new WeChat_TwoLearnTodo();
            item.Id = varId;
            item.Title = varTitle;
        ...
        public static void Update(string varId, string varTitle, string varConetent, string varAdminId, DateTime? varPubDate, string varEditAdminId, DateTime? varEditPubDate, string varMemo, string varExt1, string varExt2, string varExt3)
        {
            WeChat_TwoLearnTodo item = new WeChat_TwoLearnTodo();
            item.Id = varId;
            item.Title = varTitle;
