...
{
    [Serializable]
    public partial class WeChat_HighwayNousCollection : ActiveList<WeChat_HighwayNous, WeChat_HighwayNousCollection>
    {
        public WeChat_HighwayNousCollection() { }
        public WeChat_HighwayNousCollection Filter()
        {
            for (int i = this.Count - 1; i > -1; i--)
            {
                WeChat_HighwayNous o = this[i];
    ...
    [Serializable]
    public partial class WeChat_HighwayNous : ActiveRecord<WeChat_HighwayNous>, IActiveRecord
    {
        #region .ctors and Default Settings 
        public WeChat_HighwayNous()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public WeChat_HighwayNous(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WeChat_HighwayNous(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WeChat_HighwayNous(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration 
                TableSchema.Table schema = new TableSchema.Table("WeChat_HighwayNous", TableType.Table, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("WeChat_HighwayNous", schema);
            }
        }
        #endregion
        #region Props 
        ...
        {
            WeChat_HighwayNous item = new WeChat_HighwayNous();
            item.Id = varId;
            item.Title = varTitle;
