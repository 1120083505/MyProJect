...
{
    [Serializable]
    public partial class VWeChat_HighwayDynamicCollection : ReadOnlyList<VWeChat_HighwayDynamic, VWeChat_HighwayDynamicCollection>
    {
        public VWeChat_HighwayDynamicCollection() { }
    }
    [Serializable]
    public partial class VWeChat_HighwayDynamic : ReadOnlyRecord<VWeChat_HighwayDynamic>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("VWeChat_HighwayDynamic", TableType.View, DataService.GetInstance("ZrCon"));
                ...
                BaseSchema = schema;
                DataService.Providers["ZrCon"].AddSchema("VWeChat_HighwayDynamic", schema);
            }
        }
        #endregion
        ...
        #endregion
        #region .ctors 
        public VWeChat_HighwayDynamic()
        {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public VWeChat_HighwayDynamic(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public VWeChat_HighwayDynamic(object keyID)
        {
            SetSQLProps();
            LoadByKey(keyID);
        }

        public VWeChat_HighwayDynamic(string columnName, object columnValue)
        {
            SetSQLProps();
